...
ALTER TABLE reports ADD COLUMN IF NOT EXISTS resolved_by TEXT REFERENCES users(id) ON DELETE SET NULL;
...
ALTER TABLE reports DROP CONSTRAINT IF EXISTS erasure_reports_resolved_by_users_fk;
ALTER TABLE reports ADD CONSTRAINT erasure_reports_resolved_by_users_fk
