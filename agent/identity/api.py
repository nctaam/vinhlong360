# -*- coding: utf-8 -*-
"""Miền ĐỊNH DANH — Authentication (OTP + Password), phiên, 2FA, hồ sơ,
...
Chuyển NGUYÊN VĂN từ `auth.py` (2026-08-28, lát thứ năm — cuối cùng của chương
trình module). Như community/: đổi-nhà một-một (auth.py đã là miền-đơn, chỉ 5
ký hiệu bị ngoài import), không tách gì. Docstring gốc giữ nguyên ở trên —
"nguyên văn" bao gồm cả tài liệu (rào `test_docstring_updated` soi nó).

CẢNH GIÁC TRỤC 4 GẤP TÁM (chỉ đạo chủ dự án): 23 fixture vá `auth.db` — vùng
sự cố B1 lớn nhất chương trình. Checklist §46.3 bắt buộc: đếm DB thật
