...
trong toàn repo là agent/tests/test_resilience.py. Docstring cũ khẳng định module
đang phục vụ endpoint sức khoẻ và giám sát — không đúng, và đã khiến một đợt
audit tin rằng hệ thống có giám sát pipeline trong khi thực tế không có.
