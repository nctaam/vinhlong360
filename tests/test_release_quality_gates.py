...
def test_apply_migrations_runner_uses_legacy_baseline_and_latest_plan():
    ...
    assert pending_after_legacy_baseline == [
        ...
        "071_restore_entity_rating_triggers.sql",
        "072_feedback_receipts.sql",
        ...
        "082_unicode_digit_region_safety.sql",
        ...
        "087_report_authority.sql",
        "088_scheduler_leases.sql",
        "089_provider_delivery_receipts.sql",
        "090_image_suggestion_pending_unique.sql",
    ]
