...
.status-ok .stat-value { color: var(--primary); }
...
.dark .admin-nav a.active { background: rgba(var(--white-rgb),.14); color: var(--ink); box-shadow: inset 4px 0 0 var(--primary-fg); }
