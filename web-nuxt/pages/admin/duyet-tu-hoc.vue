...
.dark .dth-conf-low { background: rgba(var(--warning-rgb),.14); color: var(--color-warning); }
.dark .dth-tool-label { color: var(--ink); }
.dark .dth-count-warn { background: rgba(var(--warning-rgb),.12); color: var(--color-warning); }
