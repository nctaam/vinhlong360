...
.cs-chip:hover { border-color: var(--color-action); color: var(--color-action); transform: translateY(-1px); }
...
.cs-card:focus-visible {
  ...
  box-shadow: 0 0 0 5px color-mix(in oklab, var(--color-action) 14%, transparent);
}
