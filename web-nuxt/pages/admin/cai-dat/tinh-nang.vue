...
.ff-toggle input:focus-visible + .ff-track { outline: 2px solid var(--primary, #219653); outline-offset: 2px; }
...
.sf-reset:focus-visible { outline: 2px solid var(--primary, #219653); outline-offset: 2px; }
