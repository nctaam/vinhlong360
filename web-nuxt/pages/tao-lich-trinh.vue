...
.stop-num { width: 28px; height: 28px; border-radius: 50%; background: var(--mangthit-600); color: var(--color-on-action, var(--white)); display: flex; align-items: center; justify-content: center; font-size: var(--text-sm); font-weight: var(--weight-bold); font-variant-numeric: tabular-nums; flex-shrink: 0; z-index: 1; box-shadow: 0 0 0 2px color-mix(in srgb, var(--mangthit-600) 25%, transparent); }
...
.scheduled-interval { display: block; margin-top: var(--space-2); color: var(--color-action); font-size: var(--text-xs); font-weight: var(--weight-semibold); font-variant-numeric: tabular-nums; }
