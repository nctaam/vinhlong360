...
const MOTIFS: Record<string, string> = {
  'vinh-long': '<svg viewBox="0 0 200 100" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><path d="M0 60 Q25 45 50 60 T100 60 T150 60 T200 60" fill="none" stroke="var(--white)" stroke-width="2"/><path d="M0 75 Q25 60 50 75 T100 75 T150 75 T200 75" fill="none" stroke="var(--white)" stroke-width="2"/><path d="M0 45 Q25 30 50 45 T100 45 T150 45 T200 45" fill="none" stroke="var(--white)" stroke-width="2"/></svg>',
  'ben-tre': '<svg viewBox="0 0 200 100" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="var(--white)" stroke-width="2" stroke-linecap="round"><path d="M150 95 V40"/><path d="M150 42 Q120 30 95 36"/><path d="M150 42 Q180 30 200 38"/><path d="M150 45 Q125 48 105 62"/><path d="M150 45 Q178 50 195 64"/><path d="M150 40 Q150 22 152 8"/></g></svg>',
  'tra-vinh': '<svg viewBox="0 0 200 100" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg"><g fill="none" stroke="var(--white)" stroke-width="2"><ellipse cx="100" cy="60" rx="10" ry="26"/><ellipse cx="100" cy="60" rx="10" ry="26" transform="rotate(40 100 60)"/><ellipse cx="100" cy="60" rx="10" ry="26" transform="rotate(-40 100 60)"/><ellipse cx="100" cy="60" rx="10" ry="26" transform="rotate(75 100 60)"/><ellipse cx="100" cy="60" rx="10" ry="26" transform="rotate(-75 100 60)"/></g></svg>',
}
...
.wp-hero.area-vinh-long { background: linear-gradient(135deg, var(--color-material-clay) 0%, color-mix(in srgb, var(--color-material-clay), var(--clay-400)) 50%, var(--clay-400) 100%); }
.wp-hero.area-ben-tre { background: linear-gradient(135deg, var(--leaf-700) 0%, var(--color-material-leaf) 50%, color-mix(in srgb, var(--color-material-leaf) 65%, var(--white)) 100%); }
.wp-hero.area-tra-vinh { background: linear-gradient(135deg, color-mix(in srgb, var(--color-material-river) 80%, var(--black)) 0%, var(--color-material-river) 50%, color-mix(in srgb, var(--color-material-river) 65%, var(--white)) 100%); }
/* Dark mode: darken bottom stop for 4.5:1 AA on white text */
.dark .wp-hero.area-vinh-long { background: linear-gradient(135deg, color-mix(in srgb, var(--color-material-clay) 75%, var(--black)) 0%, var(--clay-700) 50%, color-mix(in srgb, var(--clay-700) 88%, var(--black)) 100%); }
...
.dark .wp-hero.area-tra-vinh { background: linear-gradient(135deg, color-mix(in srgb, var(--color-material-river) 55%, var(--black)) 0%, color-mix(in srgb, var(--color-material-river) 70%, var(--black)) 50%, color-mix(in srgb, var(--color-material-river) 58%, var(--black)) 100%); }

/* Cinematic scrim: lift text legibility + add owned-by-region radial glow */
.wp-hero::before {
  content: ''; position: absolute; inset: 0; z-index: 0; pointer-events: none;
  background:
    radial-gradient(circle at 12% 0%, rgba(var(--white-rgb),.16), transparent 55%),
    linear-gradient(to bottom, transparent 0%, rgba(var(--black-rgb),.12) 100%);
}
.dark .wp-hero::before {
  background:
    radial-gradient(circle at 12% 0%, rgba(var(--white-rgb),.10), transparent 55%),
    linear-gradient(to bottom, transparent 0%, rgba(var(--black-rgb),.28) 100%);
}
...
.wp-region a { color: var(--text-on-dark, var(--white)); text-decoration: underline; text-underline-offset: 3px; border-radius: var(--radius-control); }
...
@media (max-width: 480px) {
  .wp-hero { padding: var(--space-6) var(--space-5); border-radius: var(--radius-surface); }
  ...
  .wp-map-container { height: 260px; border-radius: var(--radius-control); }
