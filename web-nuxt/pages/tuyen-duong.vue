<template>
  <section class="page" data-color-system="tri-region-v1">
    ...
    <section class="catalog-hero cat-route">
      ...
      <div class="route-vignette" role="img" aria-label="Vị trí các tuyến đường khám phá khắp 124 xã, phường tỉnh Vĩnh Long">
        ...
        <div class="rv-labels" aria-hidden="true">
          <span>Trung tâm Vĩnh Long</span><span>Di sản Mang Thít</span><span>Cù lao An Bình &amp; Trà Ôn</span>
        </div>
      </div>
    </section>
