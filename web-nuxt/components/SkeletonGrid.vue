...
.sk-line { border-radius: var(--radius-control); background: linear-gradient(90deg, var(--bg-warm) 25%, var(--line, var(--sand-300)) 50%, var(--bg-warm) 75%); background-size: 200% 100%; animation: shimmer 1.5s infinite; }
