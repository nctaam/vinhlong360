...
@media (max-width: 820px) {
  ...
  .md-tag { font-size: .8rem; padding: var(--space-1) 10px; border-radius: var(--radius-full); background: var(--surface-2); color: var(--color-action); white-space: nowrap; text-decoration: none; font-weight: 500; }
  .md-tag:hover { background: var(--color-action); color: var(--color-on-action); }
