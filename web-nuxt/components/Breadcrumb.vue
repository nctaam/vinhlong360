...
.breadcrumb a { color: var(--primary-fg); text-decoration: none; transition: color .3s var(--ease-out), background .3s var(--ease-out); padding: 2px 6px; margin: -2px -6px; border-radius: var(--radius-sm); }
