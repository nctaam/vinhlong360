...
.breadcrumb a { color: var(--primary-fg); text-decoration: none; transition: color var(--duration-fast) var(--ease-out), background var(--duration-fast); padding: 2px 6px; margin: -2px -6px; border-radius: var(--radius-sm); }
