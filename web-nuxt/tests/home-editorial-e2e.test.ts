...
describe('Tier 2: Boundary & Corner Cases — R5 Strict Safety Standards', () => {
  ...
  it('B5.5: protects database SHA-256 hash constants from tampering across test files', () => {
    const expectedDbHash = 'b25a8a2b143f1fb063b4a6e16ed0547ba4a79449c6d23c75d467d1e2bdb99eeb'
    const expectedJsonHash = 'fb11a0d57c8cf5230e03b0e9bf6ac96c349d67cfd3110ab6bcd12db30bd8792d'
