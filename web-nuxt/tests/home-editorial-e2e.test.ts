...
describe('Tier 2: Boundary & Corner Cases — R5 Strict Safety Standards', () => {
  ...
  it('B5.5: protects database SHA-256 hash constants from tampering across test files', () => {
    const expectedDbHash = '0507c53212adcfe2fb36468ac8c4566f0fe6f62e8d8bb79f055e6e9b1a9b7513'
    const expectedJsonHash = '3ee4ec3322db2febf92dcdfdcd8bcf7f4af8bd8319f953f66b81fc22c8e92d2d'
