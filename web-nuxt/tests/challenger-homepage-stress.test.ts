...
describe('Challenger 1: Empirical Adversarial Stress & Edge Case Harness', () => {
  ...
  describe('Objective 2: Bit-for-Bit SHA-256 Invariance of Database and Data JSON', () => {
    it('asserts vinhlong360.db exactly matches canonical hash 5f3c65f9e9af60a7bfc8460b817cd2490802e1a12f5d7958ef5f0e1653b4973c', () => {
      ...
      expect(hash.toLowerCase()).toBe('5f3c65f9e9af60a7bfc8460b817cd2490802e1a12f5d7958ef5f0e1653b4973c')
    })

    it('asserts web/data.json exactly matches canonical hash 1df058d927b7860f80dd2f2ccdb62017b43a3eee3b38c44651c8fd42dbc2f098', () => {
      ...
      expect(hash.toLowerCase()).toBe('1df058d927b7860f80dd2f2ccdb62017b43a3eee3b38c44651c8fd42dbc2f098')
    })
  })
})
