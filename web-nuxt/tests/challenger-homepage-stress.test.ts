...
describe('Challenger 1: Empirical Adversarial Stress & Edge Case Harness', () => {
  ...
  describe('Objective 2: Bit-for-Bit SHA-256 Invariance of Database and Data JSON', () => {
    it('asserts vinhlong360.db exactly matches canonical hash 9410cf31ae12e9f34aff491f66ad7929cfc84dc12313f51de22d3d3db38558de', () => {
      ...
      expect(hash.toLowerCase()).toBe('9410cf31ae12e9f34aff491f66ad7929cfc84dc12313f51de22d3d3db38558de')
    })

    it('asserts web/data.json exactly matches canonical hash 309128e11fa0eda28a0762a3e670be0b0dfce424ff2c328aa555fe3f2e436a0b', () => {
      ...
      expect(hash.toLowerCase()).toBe('309128e11fa0eda28a0762a3e670be0b0dfce424ff2c328aa555fe3f2e436a0b')
    })
  })
})
