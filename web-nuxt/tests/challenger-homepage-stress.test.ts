...
describe('Challenger 1: Empirical Adversarial Stress & Edge Case Harness', () => {
  ...
  describe('Objective 2: Bit-for-Bit SHA-256 Invariance of Database and Data JSON', () => {
    it('asserts vinhlong360.db exactly matches canonical hash 8e1b1e317824bbc68f54c1a88868586496bd5b56972c0e090c63b1ff4223c93a', () => {
      ...
      expect(hash.toLowerCase()).toBe('8e1b1e317824bbc68f54c1a88868586496bd5b56972c0e090c63b1ff4223c93a')
    })

    it('asserts web/data.json exactly matches canonical hash 95b2a5e791de1ec2b35aba0d12fd1b2d3cfa7c721ffd6d24c6ac4ab8cb78acf8', () => {
      ...
      expect(hash.toLowerCase()).toBe('95b2a5e791de1ec2b35aba0d12fd1b2d3cfa7c721ffd6d24c6ac4ab8cb78acf8')
    })
  })
})
