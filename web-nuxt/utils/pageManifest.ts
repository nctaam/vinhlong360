...
export const PAGE_MANIFESTS: Record<string, PageManifest> = {
  du_lich: {
    ...
    fields: heroSeoFields({
      ...
      heroSubtitle: 'Miệt vườn sông nước, cù lao xanh mát, làng nghề trăm năm — khám phá Vĩnh Long theo cách của người bản địa.',
      seoTitle: 'Du lịch Tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025) — vinhlong360',
      seoDescription: 'Trải nghiệm bản địa, điểm tham quan, lưu trú, làng nghề và ẩm thực khắp tỉnh Vĩnh Long hợp nhất (gồm các vùng Bến Tre, Trà Vinh trước 7-2025). Lọc theo loại hình, mùa vụ và khu vực.',
      ogTitle: 'Du lịch Vĩnh Long — vinhlong360',
  ...
  ocop: {
    ...
    fields: heroSeoFields({
      ...
      heroSubtitle: 'Mỗi xã một sản phẩm — sản phẩm đạt chuẩn OCOP từ tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025), chất lượng được chứng nhận.',
      seoTitle: 'Sản phẩm OCOP Vĩnh Long — Mỗi xã một sản phẩm — vinhlong360',
      seoDescription: 'Sản phẩm đạt chuẩn OCOP (Mỗi xã một sản phẩm) từ tỉnh Vĩnh Long hợp nhất (gồm vùng Bến Tre, Trà Vinh trước 7-2025) — đặc sản theo mùa, xếp hạng sao. Lọc theo số sao, khu vực và mùa vụ.',
      ogTitle: 'Sản phẩm OCOP Vĩnh Long — vinhlong360',
      ogDescription: 'Sản phẩm đạt chuẩn OCOP 3-5 sao từ tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).',
    }),
  },
  san_pham: {
    ...
    fields: heroSeoFields({
      ...
      seoDescription: 'Đặc sản & sản phẩm OCOP Vĩnh Long theo mùa — biết mùa nào ngon, mua ở đâu, ai sản xuất. Lọc theo mùa vụ, sao OCOP và khu vực.',
  ...
  luu_tru: {
    ...
    fields: heroSeoFields({
      heroTitle: 'Lưu trú',
      heroSubtitle: 'Homestay miệt vườn, nhà nghỉ ven sông, khách sạn phố — chọn nơi nghỉ phù hợp cho chuyến đi Vĩnh Long.',
      seoTitle: 'Lưu trú Vĩnh Long — Homestay, nhà vườn, khách sạn — vinhlong360',
      seoDescription: 'Homestay, nhà vườn, khách sạn và nơi nghỉ ở tỉnh Vĩnh Long hợp nhất (gồm vùng Bến Tre, Trà Vinh trước 7-2025) — chọn chỗ ở phù hợp cho chuyến đi.',
      ogTitle: 'Lưu trú Vĩnh Long — vinhlong360',
      ogDescription: 'Homestay, nhà vườn, khách sạn và nơi nghỉ ở tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).',
    }),
  },
  le_hoi: {
    ...
    fields: heroSeoFields({
      ...
      heroSubtitle: 'Lễ hội đình miếu, lễ Khmer, Nghinh Ông, giỗ danh nhân — truyền thống văn hóa 3 vùng tỉnh Vĩnh Long hợp nhất (trước 7-2025).',
      seoTitle: 'Lễ hội truyền thống — vinhlong360',
      seoDescription: 'Lễ hội đình miếu, lễ Khmer, Nghinh Ông, giỗ danh nhân — truyền thống văn hóa tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).',
      ogTitle: 'Lễ hội truyền thống — vinhlong360',
      ogDescription: 'Lịch lễ hội truyền thống Vĩnh Long: Kỳ Yên, Ok Om Bok, Nghinh Ông, giỗ danh nhân và hơn thế.',
    }),
  },
  su_kien: {
    ...
    fields: heroSeoFields({
      heroTitle: 'Sự kiện',
      heroSubtitle: 'Sự kiện văn hóa, hội chợ, festival và hoạt động sắp diễn ra tại tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).',
      seoTitle: 'Sự kiện — vinhlong360',
      seoDescription: 'Sự kiện văn hóa, hội chợ, festival và hoạt động sắp diễn ra tại tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).',
      ogTitle: 'Sự kiện — vinhlong360',
      ogDescription: 'Lịch sự kiện Vĩnh Long: hội chợ, festival, marathon và hơn thế.',
    }),
  },
  theo_mua: {
    ...
    fields: [
      ...
      { field: 'hero_subtitle', label: 'Mô tả hero', input_type: 'textarea', default: 'Trải nghiệm, đặc sản & món ăn đang vào mùa ở tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).' },
      ...
      { field: 'seo_description', label: 'SEO description', input_type: 'textarea', default: 'Trải nghiệm, đặc sản và món ăn đang vào mùa theo từng tháng tại tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).' },
      { field: 'og_title', label: 'OG title (chia sẻ MXH)', input_type: 'text', default: 'Bản đồ trải nghiệm theo mùa — vinhlong360' },
      { field: 'og_description', label: 'OG description', input_type: 'textarea', default: 'Tháng này Vĩnh Long có gì? Khám phá đặc sản & trải nghiệm đúng mùa.' },
    ],
  },
  danh_ba: {
    ...
    fields: heroSeoFields({
      ...
      heroSubtitle: 'Địa chỉ & liên hệ UBND, công an và cơ quan công vụ theo từng xã/phường của tỉnh Vĩnh Long (sau hợp nhất: Vĩnh Long · Bến Tre · Trà Vinh trước 7-2025).',
      seoTitle: 'Danh bạ hành chính xã/phường — vinhlong360',
      seoDescription: 'Địa chỉ, số điện thoại UBND, công an và cơ quan công vụ theo 124 xã/phường tỉnh Vĩnh Long hợp nhất (gồm khu vực Bến Tre, Trà Vinh trước 7-2025).',
      ogTitle: 'Danh bạ hành chính xã/phường — vinhlong360',
      ogDescription: 'Địa chỉ, số điện thoại UBND, công an và cơ quan công vụ theo 124 xã/phường tỉnh Vĩnh Long hợp nhất (gồm khu vực Bến Tre, Trà Vinh trước 7-2025).',
    }),
  },
  tuyen_duong: {
    ...
    fields: heroSeoFields({
      ...
      seoTitle: 'Tuyến đường gợi ý — Vòng khám phá Vĩnh Long — vinhlong360',
      seoDescription: 'Các tuyến đường tự khám phá qua miệt vườn, làng nghề và văn hóa tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025). Vòng trái cây, vòng dừa, vòng chùa Khmer.',
      ogTitle: 'Tuyến đường gợi ý — vinhlong360',
      ogDescription: 'Vòng trái cây, vòng dừa, vòng chùa Khmer — tuyến tự khám phá Vĩnh Long.',
    }),
  },
  cong_dong: {
    ...
    fields: [
      ...
      { field: 'seo_description', label: 'SEO description', input_type: 'textarea', default: 'Chia sẻ trải nghiệm, đánh giá và kết nối với cộng đồng yêu du lịch tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).' },
      { field: 'og_title', label: 'OG title (chia sẻ MXH)', input_type: 'text', default: 'Cộng đồng — vinhlong360' },
      { field: 'og_description', label: 'OG description', input_type: 'textarea', default: 'Chia sẻ trải nghiệm, đánh giá và kết nối với cộng đồng yêu du lịch Vĩnh Long.' },
    ],
  },
  tim_kiem: {
    ...
    fields: heroSeoFields({
      heroTitle: 'Tìm kiếm',
      heroSubtitle: 'Tìm đặc sản, trải nghiệm, lưu trú, lễ hội — mọi thứ về tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025).',
  ...
  lien_he: {
    ...
    fields: heroSeoFields({
      heroTitle: 'Liên hệ',
      heroSubtitle: 'vinhlong360.vn — Nền tảng du lịch & đặc sản tỉnh Vĩnh Long hợp nhất (3 vùng trước 7-2025)',
