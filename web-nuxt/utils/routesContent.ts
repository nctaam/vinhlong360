...
export const DEFAULT_ROUTES: RouteDef[] = [
  ...
  {
    id: 'vong-dua-ben-tre',
    name: 'Vòng dừa Bến Tre (trước 7-2025)',
    emoji: '🥥',
    area: 'ben-tre',
    duration: '1 ngày',
    distance: '~35 km',
    ...
    stops: [
      ...
      { name: 'Vườn bưởi da xanh', note: 'Trái cây đặc trưng vùng Bến Tre (cũ)' },
      { name: 'Chợ Bến Tre (cũ)', note: 'Đặc sản: bánh tráng, bánh phồng' },
    ],
    tips: 'Kết hợp chèo xuồng trên rạch dừa. Nên đi sáng sớm để tránh nắng.',
  },
  {
    id: 'vong-chua-khmer-tra-vinh',
    name: 'Vòng chùa Khmer Trà Vinh (trước 7-2025)',
    emoji: '🛕',
    area: 'tra-vinh',
    duration: '1–2 ngày',
    distance: '~60 km',
    ...
    stops: [
      ...
      { name: 'Chùa Âng', note: 'Chùa Khmer cổ nhất khu vực Trà Vinh (cũ)' },
      { name: 'Chùa Hang', note: 'Kiến trúc hang động độc đáo' },
      { name: 'Làng Khmer', note: 'Tìm hiểu đời sống văn hóa' },
      { name: 'Quán bún nước lèo', note: 'Món đặc trưng khu vực Trà Vinh (cũ)' },
  ...
  },
  {
    ...
    duration: '1–2 ngày',
    distance: '~50 km',
    description: 'Vòng ẩm thực xuyên 3 vùng đất tỉnh Vĩnh Long hợp nhất — từ bánh xèo Vĩnh Long, kẹo dừa Bến Tre đến bún nước lèo Trà Vinh (trước 7-2025).',
    stops: [
      ...
      { name: 'Kẹo dừa Bến Tre (cũ)', note: 'Nếm + mua về làm quà' },
      { name: 'Bún nước lèo Trà Vinh (cũ)', note: 'Món Khmer không thể bỏ qua' },
    ],
