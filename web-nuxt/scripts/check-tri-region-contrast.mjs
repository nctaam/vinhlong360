...
const approvedConsumerTuples = new Set([
  ...
  ['assets/css/base.css', 'top level', '.hero-search input', 'border-radius', 'var(--radius-surface)'],
  ...
  ['assets/css/base.css', 'top level', '.hero-search button', 'border-radius', 'var(--radius-surface)'],
  ...
  ['assets/css/base.css', 'top level', '.dark .hero-search:focus-within', 'border-color', 'var(--color-action)'],
  ['assets/css/base.css', 'top level', '.dark .hero-search:focus-within', 'box-shadow', '0 0 0 3px rgba(var(--color-action-rgb), .18)'],
  ['assets/css/base.css', '@media (forced-colors: active)', '.btn,.tag,.chip,.badge,.auth-btn,[data-color-role="action-primary"],.btn-primary,button,input,select,textarea,summary,[role="button"]', 'border', '1px solid ButtonText !important'],
  ...
  ['pages/index.vue#style-0', 'top level', '.home .hero-search', 'border-radius', 'calc(var(--radius-surface) + var(--space-1))'],
  ...
  ['pages/index.vue#style-0', 'top level', '.ec-date', 'border-radius', 'var(--radius-control)'],
  ...
  ['assets/css/home-nocturne.css', 'top level', '[data-home-pilot="nocturne-b1"] .hero-sub', 'border-radius', 'var(--radius-control, 8px)'],
  ...
  ['assets/css/home-nocturne.css', 'top level', '[data-home-pilot="nocturne-b1"] .hero-search[data-color-role="action-primary"]', 'border', '1px solid var(--color-action)'],
  ['assets/css/home-nocturne.css', 'top level', '[data-home-pilot="nocturne-b1"] .hero-search[data-color-role="action-primary"]', 'border-radius', 'var(--radius-control)'],
  ...
  ['assets/css/home-nocturne.css', 'top level', '[data-home-pilot="nocturne-b1"] .hero-search[data-color-role="action-primary"]', 'box-shadow', 'none'],
  ...
  ['assets/css/home-nocturne.css', 'top level', '[data-home-pilot="nocturne-b1"] .hero-nearby', 'color', 'var(--color-action)'],
  ['assets/css/home-nocturne.css', 'top level', '[data-home-pilot="nocturne-b1"] .hero-nearby', 'text-shadow', 'none'],
  ...
  ['assets/css/home-nocturne.css', 'top level', '[data-home-pilot="nocturne-b1"] .home-feature-dossier__action', 'border-radius', 'var(--radius-control)'],
