---
name: VinhLong360 Unified Anti-Slop Editorial Design Constitution
project_id: "14916181929760067680"
title: "VinhLong360 - Mekong River Heritage & Discovery Platform"
date: "2026-09-13"
status: "active"
standard: "Stitch Taste Design / Google Stitch MCP / WCAG 2.2 AAA"
dfii_score: "19/15"
colors:
  primary: "#006798"
...
> **Status (2026-09-13):** Active — Single Source of Truth cho toàn bộ nền tảng Vĩnh Long 360 và Google Stitch Project `14916181929760067680`.
> **Cơ sở thực thi:** CLAUDE.md, PROJECT.md, và Khảo sát Thiết kế Spec Miner.

---

## 1. Tuyên Ngôn Triết Lý Thiết Kế & Không Khí Thẩm Mỹ (Visual Atmosphere)

Vĩnh Long 360 không phải là một danh bạ du lịch thương mại thông thường, cũng không phải một ứng dụng sinh giao diện rập khuôn bằng trí tuệ nhân tạo. Đây là **Hệ thống Số Hóa Di Sản & Khám Phá Miền Đất Cửu Long** — kết hợp tính chính trực tuyệt đối của dữ liệu bản địa với mỹ học thủ công tinh xảo (high craftsmanship).

- **Mật độ (Density Spectrum): 5/10 — Art Gallery Airy:**
  Khoáng đạt như khúc sông Tiền lúc rạng đông. Tôn trọng khoảng trắng có chủ đích, giải phóng thị giác khỏi sự bức bối của các thẻ bài nhồi nhét. Mỗi đối tượng di sản được trưng bày như một cổ vật trong không gian bảo tàng.
- **Độ biến thiên (Variance Spectrum): 7/10 — Offset Asymmetric:**
  Phá vỡ tính đối xứng vô cảm của các khuôn mẫu SaaS thông thường. Sử dụng tỷ lệ vàng biên tập 62/38 và dải tiếp sóng lệch tâm (Dual-Rail Feed 1.35:1) để dẫn dắt sự chú ý của người đọc một cách tự nhiên.
- **Chuyển động (Motion Spectrum): 6/10 — Fluid Spring Physics:**
  Độ trễ êm ái, đầm chắc như nhịp chèo xuồng ba lá trên dòng Cổ Chiên. Gia tốc lò xo vật lý `cubic-bezier(0.16, 1, 0.3, 1)` đem lại cảm giác xúc giác chân thực trên từng cú chạm.

---

## 2. Bốn Chuẩn Mực Quốc Tế (The 4 International Benchmarks)
...
## 3. Bảng Màu Thổ Nhưỡng Tam Vùng & Hợp Đồng Màu Sắc (Terroir Palette)

Bảng màu được chưng cất từ thổ nhưỡng, sông ngòi và văn hóa bản địa Vĩnh Long mới (hợp nhất không gian Cửu Long duyên hải):

| Nhóm Màu | Tên Thổ Nhưỡng | Mã Hex / Token | Vai Trò Chức Năng | Tương Phản WCAG 2.2 |
|---|---|---|---|---|
| **Sông Nước** | Xanh Cổ Chiên Sáng | `#006798` (`--river-500`) | Chỉ dấu bản đồ, liên kết điều hướng, điểm nhấn sông nước | >= 4.5:1 trên nền giấy sáng |
...
### 3.1. Viền Bắt Sáng Liquid Glass & Đổ Bóng Hữu Cơ
- **Liquid Glass Border:** `oklch(100% 0 0 / 0.12)` — Đường viền tinh thể thủy tinh mỏng bắt sáng tự nhiên trên mép card và dock điều hướng, thay thế viền xám đục.
...
Hệ thống ấn loát được xây dựng trên sự bổ trợ tương hỗ giữa tính bác học di sản và khả năng hiển thị tiếng Việt hoàn hảo:
...
- **Display & Tiêu Đề Biên Tập (Headlines):**
  ...
  - Phân cấp:
    ...
    * `headline-md`: 24px / 30px, weight 600, letter-spacing normal.
    * `headline-sm`: 20px / 26px, weight 600, letter-spacing normal.
- **Văn Bản Nội Dung & Giao Diện Chức Năng (Body & UI):**
  - Font: **`Be Vietnam Pro`** (Sans-Serif hiện đại do người Việt thiết kế, dấu thanh chuẩn mực, độ cao x-height lớn).
  - Phục vụ cho: Đoạn văn thuyết minh di sản, nhãn nút bấm, chỉ mục danh mục, bảng số liệu, tooltip.
  - Phân cấp:
...
## 5. Thang Bán Kính Ngữ Nghĩa (Semantic Radius Scale)

Dứt khoát chấm dứt việc gán `border-radius` bừa bãi hoặc lạm dụng `rounded-full` cho mọi nút bấm:
...
## 8. Động Lực Học & Vi Tương Tác Vật Lý (Motion & Spring Physics)

- **Gia Tốc Lò Xo Đầm Chắc (Spring Physics Engine):**
  - `--ease-out-expo: cubic-bezier(0.16, 1, 0.3, 1)` — Áp dụng cho mọi hiệu ứng lướt thẻ, mở menu, trượt modal.
  - Không sử dụng gia tốc tuyến tính (linear easing) gây cảm giác giật cục, rẻ tiền.
- **Phản Hồi Xúc Giác (Tactile Click Feedback):**
  - Mọi nút bấm và chip khi `:active`: `transform: scale(0.98) translateY(1px)` tạo cảm giác nhấn đầm tay như phím cơ.
- **Chỉ Chuyển Động Trên Phần Cứng Tăng Tốc:**
  - Chỉ tạo chuyển động trên hai thuộc tính GPU: `transform` và `opacity`. Tuyệt đối không animate `top`, `left`, `width`, `height`.
- **Tôn Trọng Tiếp Cận Giảm Chuyển Động:**
  - Khi người dùng bật `@media (prefers-reduced-motion: reduce)`, toàn bộ hiệu ứng chuyển động tự động chuyển sang hiệu ứng hòa tan mờ (cross-fade) tức thì.

---

## 9. Danh Mục Cấm Kỵ Tuyệt Đối (Anti-AI-Slop Banned List)

Nhằm giữ vững danh dự và linh hồn bản địa của nền tảng, 10 điều cấm kỵ sau đây có giá trị thi hành pháp lý trên toàn dự án:

1. ❌ **CẤM Icon Sparkle AI (`auto_awesome`, ✨, 🌟):**
   - Loại trừ 100% biểu tượng sparkle 4 cánh biểu thị "phép màu AI" rẻ tiền.
   - Thay thế bằng biểu tượng vector tri thức chuẩn mực: `explore`, `psychology_alt`, `menu_book`, `verified`.
...
6. ❌ **CẤM Bẫy Thương Mại & Booking Trực Tuyến (Vi phạm CLAUDE.md §1.4):**
   - Nền tảng CHỈ GIỚI THIỆU, KHÔNG bán tour, KHÔNG đặt phòng on-site, KHÔNG môi giới dịch vụ. Cấm mọi liên kết hoặc nút bấm kiểu *"Đặt hướng dẫn viên bản địa"*, *"Book phòng ngay"*.
...
## 10. Bảng Ánh Xạ Mã Nguồn Nuxt (`variables.css`) & Google Stitch MCP

Để duy trì tính toàn vẹn giữa đám mây Google Stitch và mã nguồn Nuxt sản xuất, bảng ánh xạ sau là quy chuẩn đồng bộ bắt buộc:

| Khái Niệm Thiết Kế | Google Stitch Token | Nuxt CSS Custom Property (`variables.css`) | Giá Trị Đồng Bộ |
|---|---|---|---|
