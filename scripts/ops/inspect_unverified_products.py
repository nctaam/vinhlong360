...
with open("outputs/batch_36_candidates.json", "w", encoding="utf-8") as f:
    json.dump(batch_36_candidates, f, ensure_ascii=False, indent=2)

print(f"Dumped {len(batch_36_candidates)} candidates to outputs/batch_36_candidates.json")
