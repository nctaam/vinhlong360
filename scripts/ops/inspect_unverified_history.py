...
with open("outputs/batch_38_candidates.json", "w", encoding="utf-8") as f:
    json.dump(batch_38_candidates, f, ensure_ascii=False, indent=2)

print("Dumped 40 candidates to outputs/batch_38_candidates.json")
