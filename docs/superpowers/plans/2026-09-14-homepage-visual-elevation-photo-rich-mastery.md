...
- [x] **Step 1: Khảo sát định lượng tỷ lệ diện tích Ảnh/Chữ trên màn hình hiện tại**
...
- [x] **Step 2: Tuyển chọn bộ ảnh tư liệu thực địa độ phân giải cao đã qua kiểm định**
...
- [x] **Step 3: Soạn thảo tài liệu đặc tả mỹ học `docs/superpowers/specs/2026-09-14-visual-elevation-spec.md`**
  Đảm bảo dòng 2 có header `> STATUS: active` theo chuẩn Ratchet R60.1.

- [x] **Step 4: Commit tài liệu đặc tả**
...
- [x] **Step 1: Chuẩn bị payload prompt chỉnh sửa cho `edit_screens`**
...
- [x] **Step 2: Thực thi lệnh MCP `edit_screens` trên duy nhất màn hình `113af35ecf1846e8b4dd7425c432f425`**
  Gọi MCP `call_mcp_tool` với `ServerName: "stitch"`, `ToolName: "edit_screens"`. Chỉ truyền đúng ID màn hình hiện tại.

- [x] **Step 3: Tải về và kiểm tra ảnh chụp render mới nhất**
...
- [x] **Step 4: Kiểm tra xác nhận qua Stitch MCP `list_screens`**
...
- [x] **Step 1: Viết test TDD kiểm tra tính nổi trội thị giác (Visual Prominence Test)**
...
- [x] **Step 3: Cập nhật `HomeCategoryIndex.vue` và `HomeNativeStories.vue`**
...
- [x] **Step 4: Chạy test để xác nhận trạng thái GREEN**
  `cd web-nuxt && npx vitest run tests/home-visual-prominence.test.ts`
