...
### GĐ-B — Nền móng DB (additive, CHƯA đổi hành vi đọc/ghi) — ✅ XONG 2026-07-02
...
> Bước 1-2 ✅ (060+061+062 replay sạch; prod version=62, 9 bảng CTI owner vl360;
> 062 vá cột experience.admission mà 061 sót — backfill bắt được, rollback sạch).
> Bước 3-4 ✅ (backfill prod: uni=1604, detail=1570/9 bảng, 15 giá trị chữ-trong-
> trường-số ở lại JSONB; **parity 0 lệch / 7220 giá trị**; backup db-pre-backfill-*).
> DUY NHẤT còn treo: SQLite parity + PG_REQUIRED trong database.py — gộp vào GĐ-C
> (file đang dirty refactor của session song song, chờ điều kiện tạm dừng).
