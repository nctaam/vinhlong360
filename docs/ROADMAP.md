...
- **[Content] ~203 entity mô tả mỏng (<120 ký tự)** — đã giảm từ 341→203 (2026-06-24): 138 entity làm giàu từ metadata sẵn có (facility/chợ/event/accommodation/attraction/experience/product). Còn 203 (120 dish, 46 accommodation, 37 khác) cần nghiên cứu ngoài hoặc chủ dự án bổ sung nội dung — KHÔNG bịa (§1.4).
