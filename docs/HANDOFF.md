...
- **[Ops] Production behavior chưa quan sát:** tranche này chỉ verify local ở revision `de7efa3f`; cần lệnh deploy riêng của chủ dự án mới được quan sát health/log trên production. Không push, deploy, secret change, indexing change hoặc production mutation trong tranche.
