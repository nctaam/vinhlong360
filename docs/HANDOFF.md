...
- **[P2/out-of-scope] Outbound caller chưa migrate:** `geocode._query_nominatim`, `realtime.get_weather`, `scheduler._digest_send`, `scheduler._send_telegram_admins` vẫn ngoài tranche; 2 caller cuối là POST nên không được nới contract GET ngầm để kéo vào.
