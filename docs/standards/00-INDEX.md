...
| R20.8 | complexity ≤12 | soft-ratchet | check_complexity | 47 | 20-backend.md |
...
| R30.8 | thang bo góc cũ `--radius-xs/sm/md/lg/xl` → tầng mục đích `--radius-control/surface/sheet` (đếm từng match) | hard-ratchet | check_fe_tokens | 369 | 30-frontend.md |
