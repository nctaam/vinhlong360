...
| R50.3 | Công thức mở bài cấm: "X là một...", mở bằng nhãn phân loại thay vì story-hook | pending-check (hạn: SP6) | mở rộng content_voice |
| R50.4 | Entity summary+description ≥200 ký tự (sàn); đích index-worthy = 130 TỪ (seo.py) | soft | check_thin_content |
| R50.5 | Tên tỉnh trong content theo §1.6 (đồng nhất R10.7) | hard-ratchet | check_tinh_cu |
