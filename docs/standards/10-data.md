...
| R10.8 | Entity index-worthy (RICH) phải có ≥1 `source` URL | pending-check (hạn: SP2) | mở rộng check_data_schema |
| R10.9 | Xuất xứ đặc sản/địa danh phải TRONG tỉnh (cấm gán Cái Bè/Lai Vung/Định Yên...) | soft-ratchet | check_content_voice (out_of_province) |
